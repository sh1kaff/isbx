...
from src.cracker.crack_time import  get_crack_times
...
def main():
    ...
    #     if result:
    #         break
    for x in get_crack_times("140495200b351b7f18a46e3796f2875ebdf0023568933ef3b99efb285af3f06b","2301", "547905"):
        print(x)
